...
function prompt_command() {
  PS1="\e[38;5;159m\t\n${icon_start}$(virtualenv_prompt)${icon_host}${normal}\e[1mKevin\e[38;5;254m${icon_user}${normal}${icon_directory}${bold_purple}\W${normal}\$([[ -n \$(git branch 2> /dev/null) ]] && echo \" on ${icon_branch}  \")${white}$(scm_prompt_info)${normal}\n${icon_end}"
  PS2="${icon_end}"
}
